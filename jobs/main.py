...
def simulate_vehicle_movement():
    ...
    # add some random movement to simulate actual road travel
...
def simulate_journey(producer,device_id):
    while True:
        ...
        if (vehicle_data['location'][0]>=BIRMINGHAM_COORDINATES['latitude'] and vehicle_data['latitude'][1]<=BIRMINGHAM_COORDINATES['longitude']):
